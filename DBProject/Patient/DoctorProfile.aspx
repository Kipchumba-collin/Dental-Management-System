...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style= "background-position:center; background-image:url(/assets/img/backgrounds/PatientHome.jpg); background-size:20px"> 
        ...
        <div style="margin-left: 70px">
            <div class="form3">
            <h4><strong>Name: </strong></h4> <asp:Label ID="DName" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label>
            <br /><br />
