                ...
                <div class="container grad">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <h1><strong>Neema</strong> Doctor Registration</h1>
                            
                            <div class="description">
                            	<%--<p>
	                            	This is a free <strong>"Doctor registeration form"</strong> Neema Clinic 
                                     ...
                                     <asp:CustomValidator runat="server" Display="Dynamic" ControlToValidate="Email"    ID="DV"  
                                         ...
                                         <div class="form-group">
                                             ...
                                             <asp:DropDownList ID="Department" runat="server" Width="228px" Height="39px">
                                                 ...
                                                 <asp:ListItem Text="Dental Surgery" Value="1"></asp:ListItem>
                                                 <asp:ListItem Text="lab" Value="2"></asp:ListItem>
                                                 <asp:ListItem Text="Removal of Braces" Value="3"></asp:ListItem>
                                                 <asp:ListItem Text="Consultation" Value="4"></asp:ListItem>
                                                 <asp:ListItem Text="Replacement and Removal" Value="5"></asp:ListItem>
